...
<div class="my-6">
    ...
    <div class="bg-white rounded-lg border-2 border-gray-300 overflow-hidden">
        <div class="flex justify-end px-2 py-2">
            <form class="w-full max-w-70" method="GET" action="{{ route('admin.messages.index') }}">
                <input class="w-full py-1.5 px-2 border-2 ring-0 rounded-md border-neutral-200 transition-colors duration-300 outline-none bg-white" type="search" name="search" placeholder="Search by Subject, Sender or Receiver" value="{{ request('search') }}">
            </form>
        </div>
