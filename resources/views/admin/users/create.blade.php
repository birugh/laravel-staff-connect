...
<form method="POST" action="{{ route('admin.user.store') }}" enctype="multipart/form-data">
    ...
    <div class="mb-2">
        ...
        <input class="field" minlength="5" type="text" name="name" value="{{ old('name') }}">
        @error('name')
    ...
    <div class="mb-2">
        ...
        <input class="field" minlength="5" type="password" name="password" id="passwordField">
    ...
    <div class="mb-2">
        ...
        <input class="field" minlength="5" type="password" name="password_confirmation" id="passwordConfirmField">
    ...
    <div class="mb-2">
        ...
        <select class="field req" name="role">
