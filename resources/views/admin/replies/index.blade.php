...
<div class="my-6">
    <div class="flex flex-row justify-between items-center mb-4">
        <h1 class="text-xl font-medium">Message Replies List</h1>
        <a class="btn btn-primary" href="{{ route('admin.messages.create') }}">Create Message Reply</a>
    </div>
            ...
            <table class="table table-hover mb-4">
                ...
                <tr>
                    ...
                    <td class="flex flex-row items-center gap-2">
                        <a class="btn-action group" href="{{ route('admin.messages.show', $r) }}">
